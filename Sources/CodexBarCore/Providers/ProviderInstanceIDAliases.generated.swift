...
extension ProviderInstanceID {
    ...
    public static let custom = UsageProvider.custom.instanceID
    public static let custom2 = UsageProvider.custom2.instanceID
    public static let custom3 = UsageProvider.custom3.instanceID
    public static let custom4 = UsageProvider.custom4.instanceID
    public static let custom5 = UsageProvider.custom5.instanceID
    public static let custom6 = UsageProvider.custom6.instanceID
    public static let custom7 = UsageProvider.custom7.instanceID
    public static let custom8 = UsageProvider.custom8.instanceID
    public static let custom9 = UsageProvider.custom9.instanceID
    public static let custom10 = UsageProvider.custom10.instanceID
