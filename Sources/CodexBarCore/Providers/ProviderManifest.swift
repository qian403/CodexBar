...
public enum ProviderManifest {
    public static let allDescriptors: [ProviderDescriptor] = [
        ...
        CustomProviderDescriptors.descriptor(for: .custom),
        CustomProviderDescriptors.descriptor(for: .custom2),
        CustomProviderDescriptors.descriptor(for: .custom3),
        CustomProviderDescriptors.descriptor(for: .custom4),
        CustomProviderDescriptors.descriptor(for: .custom5),
        CustomProviderDescriptors.descriptor(for: .custom6),
        CustomProviderDescriptors.descriptor(for: .custom7),
        CustomProviderDescriptors.descriptor(for: .custom8),
        CustomProviderDescriptors.descriptor(for: .custom9),
        CustomProviderDescriptors.descriptor(for: .custom10),
