...
extension UsageStore {
    ...
    /// Provider-specific by design: the dashboard expands history only for providers with local history readers.
    ...
    /// Provider-specific by design: dashboard history avoids Claude fallback while widening local scans.
