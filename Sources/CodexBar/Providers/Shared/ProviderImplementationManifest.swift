...
enum ProviderImplementationManifest {
    static let makeImplementations: [@Sendable () -> any ProviderImplementation] = [
        ...
        { CustomProviderImplementation(id: .custom) },
        { CustomProviderImplementation(id: .custom2) },
        { CustomProviderImplementation(id: .custom3) },
        { CustomProviderImplementation(id: .custom4) },
        { CustomProviderImplementation(id: .custom5) },
        { CustomProviderImplementation(id: .custom6) },
        { CustomProviderImplementation(id: .custom7) },
        { CustomProviderImplementation(id: .custom8) },
        { CustomProviderImplementation(id: .custom9) },
        { CustomProviderImplementation(id: .custom10) },
