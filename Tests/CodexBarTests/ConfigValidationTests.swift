...
struct ConfigValidationTests {
    ...
    func `unsupported enterprise host warning lists every supported provider`() throws {
        ...
        #expect(issue.message ==
            "enterpriseHost is set but only azureopenai, clawrouter, copilot, custom, custom10, custom2, custom3, " +
            "custom4, custom5, custom6, custom7, custom8, custom9, kimi, litellm, llmproxy, openrouter, " +
